...
\graphicspath{{img/}}
%\includeonly{tex/introduction, tex/reference}
%\includeonly{tex/project}
%\includeonly{tex/requirement}
%\includeonly{tex/design}
%\includeonly{tex/verification}
...
%Supervisor: Professor Babak Esfandiari\\
